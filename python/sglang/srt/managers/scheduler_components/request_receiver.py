        ...
        for req in recv_reqs:
            if isinstance(req, (TokenizedGenerateReqInput, TokenizedEmbeddingReqInput)):
                ...
                if isinstance(req, TokenizedGenerateReqInput):
                    req.mm_data_mooncake = unwrap_from_pickle(req.mm_data_mooncake)
                ...
                for sub_req in req:
                    ...
                    if isinstance(sub_req, TokenizedGenerateReqInput):
                        sub_req.mm_data_mooncake = unwrap_from_pickle(
                            sub_req.mm_data_mooncake
                        )
