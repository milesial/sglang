...
class TestSWAEvictionBoundary(unittest.TestCase):
    ...
    def test_formula_page_leq_window(self):
        ...
        for seq_len in [13, 17, 25, 33]:
            ...
            tree.cache_finished_req(
                req, is_insert=True, kv_committed_len=req._kv_committed_len
            )
            tree.sanity_check()
    ...
    def test_insert_case1_evicted_within_matched(self):
        ...
        tree.cache_finished_req(
            req1, is_insert=True, kv_committed_len=req1._kv_committed_len
        )
        tree.sanity_check()
        ...
        tree.cache_finished_req(
            req2, is_insert=True, kv_committed_len=req2._kv_committed_len
        )
