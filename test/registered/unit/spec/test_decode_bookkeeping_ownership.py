...
_OWNER_SITES = {
    ...
    ("mem_cache/owned_kv_allocation.py", "alloc_for_extend", "evict"): 1,
    ("mem_cache/owned_kv_allocation.py", "alloc_for_extend", "kv_allocated_len"): 1,
    ("mem_cache/owned_kv_allocation.py", "alloc_for_decode", "evict"): 1,
    ("mem_cache/owned_kv_allocation.py", "alloc_for_decode", "kv_allocated_len"): 1,
    ...
    (
        "mem_cache/owned_kv_allocation.py",
